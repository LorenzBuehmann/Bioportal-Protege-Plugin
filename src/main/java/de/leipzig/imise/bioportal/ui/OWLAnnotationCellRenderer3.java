 ...
 * Date: 14/11/2011
 * <p>
 * A replacement for {@link org.protege.editor.owl.ui.renderer.OWLAnnotationCellRenderer}.  This version renders annotations using {@link Page}
 * objects and helps to avoid the problem of wrapping and overflow errors that arose with the old renderer.
 * </p>
 */
public class OWLAnnotationCellRenderer3 extends PageCellRenderer {
    ...
    public OWLAnnotationCellRenderer3(OWLEditorKit editorKit) {
        super();
    ...
    private void renderCellValue(Page page, Object value, Color foreground, Color background, boolean isSelected) {
        ...
        if (annotation != null) {
            OWLAnnotationSubject subject = ((OWLAnnotationAssertionAxiom) value).getSubject();
            renderAnnotationProperty(page, subject, annotation, foreground, background, isSelected);
     ...
     */
    private Paragraph renderAnnotationProperty(Page page, OWLAnnotationSubject subject, OWLAnnotation annotation,
        ...
        paragraph.append(rendering, foreground);
